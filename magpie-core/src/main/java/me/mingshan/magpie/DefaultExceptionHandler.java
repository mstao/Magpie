 ...
 * @author mingshan
 */
public class DefaultExceptionHandler implements ExceptionHandler<RingBufferLogEvent> {
    ...
    public void handleEventException(final Throwable throwable, final long sequence, final RingBufferLogEvent event) {
        try {
            ...
            System.err.print("AsyncReader error handling event seq=");
    ...
    public void handleOnStartException(final Throwable throwable) {
        System.err.println("AsyncReader error starting:");
        throwable.printStackTrace();
    }

    @Override
    public void handleOnShutdownException(final Throwable throwable) {
        System.err.println("AsyncReader error shutting down:");
        throwable.printStackTrace();
    }
}
